...
- Database design and management (Entity Framework, SQL)
- Web development (REST APIs + frontend)
...
- Fullstack solutions with React + .NET APIs
...
## ⭐ About Me
- I enjoy building projects from idea to production
- I value clean, structured, and well-documented code
